    ...
    return (
        <div className="w-full p-3">
            ...
            <div className="flex justify-between items-center mb-3">
                ...
                <Button variant="outline" onClick={() => exportToCsv('general-ledger', journalEntries)} disabled={journalEntries.length === 0}><Download className="mr-2 h-4 w-4" />Export</Button>
            </div>
